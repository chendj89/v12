<template>
  <div>
    <VMenu ref="vmRef" style="margin: 0 auto; display: block" :data="values" :create="true"></VMenu>
    ...
    <teleport to="#footer">
      <n-button type="primary" size="small" @click="createIssue">创建</n-button>
    </teleport>
  </div>
</template>
...
const values: any = ref<any>({
  name: '',
  icon: 'https://api.iconify.design/bi:9-square-fill.svg?color=%231a7f37',
  desc: '',
  url: '',
  sort: 999,
  padding: true,
